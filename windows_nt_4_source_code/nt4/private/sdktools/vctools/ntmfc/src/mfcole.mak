...
!ifndef LIBNAME
!error LIBNAME is not defined. LIBNAME=MFCO30 builds the prebuilt DLL.
!endif
...
LFLAGS=$(LFLAGS) /dll /subsystem:windows,4.0 /version:3.1 /base:0x5F900000
...
##!if "$(UNICODE)" == "1"
##LIBS=mfcuiw32.lib $(LIBS)
##!else
##LIBS=mfcuia32.lib mfcans32.lib $(LIBS)
##LIBS=oledlg.lib $(LIBS)
##!endif
...
$D\$(TARG).res: mfcole.rc
        rc /r $(RCDEFINES) /fo $D\$(TARG).res mfcole.rc
