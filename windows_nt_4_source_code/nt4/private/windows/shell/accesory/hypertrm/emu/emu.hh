...
struct stEmuInternal
	...
	STEMUSET	stUserSettings; 	// These structures are used to hold the
									// settings made by the user.  They are
									// initilaized from values storred in
									// the session file.
	...
	//
	int (*emu_datain)		(const HEMU hEmu, ECHAR ccode);
