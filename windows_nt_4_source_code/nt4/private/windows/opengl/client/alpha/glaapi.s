...
// Revision History:
//
//   27-Sep-1995  Marc Fortier (marcfo)
//   Now uses dwTlsOffset global for teb access
//--
...
// This macro must leave the TEB pointer in v0

#define MAKEOPENGLAPI(Func)                     \
        LEAF_ENTRY( Func )                      \
        GET_THREAD_ENVIRONMENT_BLOCK;           \
        ldl     t12, dwTlsOffset(zero);         \
        addl    v0, t12, t12;                   \
        ldl     t12, 0x0(t12);                  \
...
#define FASTOPENGLAPI(Func)                     \
        LEAF_ENTRY( Func )                      \
        GET_THREAD_ENVIRONMENT_BLOCK;           \
        ldl     t12, (TeglDispatchTable+(FASTINDEX_##Func*4))(v0); \
        jmp     zero, (t12), 0x0;               \
        .end    Func;
