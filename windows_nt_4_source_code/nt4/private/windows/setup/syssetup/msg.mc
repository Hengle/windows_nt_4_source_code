...
MessageId=60012 SymbolicName=MSG_CONFIGURING_COMPUTER
Language=English
Setup is configuring your computer to run Windows NT...
.

MessageId=60013 SymbolicName=MSG_UPGRADING
Language=English
Setup is upgrading Windows NT...
.

MessageId=60014 SymbolicName=MSG_REMOVING_LOCALSRC
Language=English
Setup is removing temporary installation files...
.

MessageId=60015 SymbolicName=MSG_PREPARING_OPTDIRS
Language=English
...
Language=English
Windows NT has been successfully upgraded to version 4.00.
...
Language=English
Windows NT 4.00 is now installed.
...
MessageId=60020 SymbolicName=MSG_UPGRADING_PRINTERS
Language=English
...
MessageId=60024 SymbolicName=MSG_CREATING_MENU_OBJECTS
Language=English
...
MessageId=61060 SymbolicName=MSG_LOG_OPTIONAL_COMPONENT_ERROR
Language=English
...
MessageId=61063 SymbolicName=MSG_LOG_OC_REGISTRY_ERROR
Language=English
...
; //  (i.e., Win95-only INF).
; //
MessageId=62300 SymbolicName=MSG_DRIVERNODE_WIN95_ONLY
Language=English
...
; //
MessageId=63000 SymbolicName=MSG_CAIRO_BAD_USER_NAME
Language=English
